...
class QuestionTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $questions = [
            ...
            [
                'title'                     => '',
                'body'              		=> 'Mijn organisatie biedt hulp bij het op orde krijgen van de financiële situatie en deze hulp is toegankelijk en makkelijk vindbaar voor alle inwoners. Als uw organisatie zelf geen dienstverlening aanbiedt, geef dan cijfer 0.',
                'weergave_succesfactor'     => '',
                'norm'                      => 'Mijn organisatie biedt hulp bij het op orde krijgen van de financiële situatie en deze hulp is toegankelijk en makkelijk vindbaar voor alle inwoners. Als uw organisatie zelf geen dienstverlening aanbiedt, geef dan cijfer 0.',
                'theme_id' => 2,
            ],
            [
                'title'                     => '',
