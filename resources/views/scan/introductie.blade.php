        ...
        <div class="row">
            <div class="col-md-12">
                <div class="page--title">
                    ...
                    <p>Bekijk de introductiefilm over het uitvoeren van de participatiescan of ga door naar het volgende scherm. We adviseren de film op een gezamenlijk scherm te bekijken. Klik <a href="https://www.youtube.com/watch?v=oOSoBnCPHlk">hier</a> als de video niet verschijnt.</p>
                </div>
            </div>
        </div>
        <div class="row">
